...
from stock_pool_strategy_self import stock_pool, find_out_stocks
from stock_util_self import get_trading_dates
from macd_factor_self import is_macd_dead, is_macd_gold
...
def backtest(begin_date, end_date):
    ...
    hs300_begin_value = DB_CONN['daily'].find_one(
        {'code': '000001.SZ', 'index': True, 'date': all_dates[0]},
    ...
    for _date in all_dates:
        ...
        hs300_current_value = DB_CONN['daily'].find_one(
            {'code': '000001.SZ', 'index': True, 'date': _date},
            projection={'close': True})['close']
