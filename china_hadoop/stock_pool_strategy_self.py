...
def statistic_stock_pool():
    ...
    adjust_dates, codes_dict = stock_pool('20150101', '20151231')
    ...
    hs300_begin_value = daily.find_one({'code': '000001.SZ', 'index': True, 'date': adjust_dates[0]})['close']
    ...
    for _index in range(1, len(adjust_dates) - 1):
        ...
        if count > 0:
            ...
            # 当前沪深300的值
            hs300_close = daily.find_one({'code': '000001.SZ', 'index': True, 'date': current_adjust_date})['close']
